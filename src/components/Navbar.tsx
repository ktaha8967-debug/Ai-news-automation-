    ...
    <header className="bg-white border-b border-slate-200">
      ...
      <div className="border-b border-slate-100 py-1.5 px-4 text-xs text-slate-500 bg-slate-50 font-sans">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="/google-news-sitemap.xml" target="_blank" className="hover:text-slate-900 transition-colors hidden sm:inline">
              Google News Feed
            </a>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex items-center justify-between border-b border-slate-200">
        ...
        <div className="flex items-center gap-3 w-36 justify-end">
          <Link href="/topics/llm-foundation-models" className="p-2 text-slate-600 hover:text-slate-900 rounded-lg hover:bg-slate-100 transition-colors" title="Search Topics">
          ...
          <button
            ...
            className="lg:hidden p-2 text-slate-700 hover:text-slate-900 rounded-lg border border-slate-200"
